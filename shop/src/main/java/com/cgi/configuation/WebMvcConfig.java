 ...
 *                  bean definitions
 * @ComponentScan - this annotation is used to search for 
 * the Spring components amongst the application
 * @EnableWebMvc - Adding this annotation to an 
